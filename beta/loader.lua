...
callbacks.Loader = function(g)
    ...
    Plox.Text = "Plox"
    Plox.TextColor3 = Color3.fromRGB(72, 72, 72)
    ...
    tysm.Text = "This is the beta UI of PloxHud."
    tysm.TextColor3 = Color3.fromRGB(0, 0, 0)
    tysm.TextSize = 12.000
    tysm.Visible = false
  
    tysmr.Name = "tysmr"
    tysmr.Parent = tysm
    tysmr.AnchorPoint = Vector2.new(0.5, 0.5)
    tysmr.BackgroundColor3 = Color3.fromRGB(196, 196, 196)
    ...
    tysmr.ImageColor3 = Color3.fromRGB(242, 242, 242)
    ...
    for i = 1,4,1 do
        ...
        game:GetService("TweenService"):Create(Hud, TweenInfo.new(0.25), {TextColor3 = Color3.fromRGB(72, 72, 72)}):Play()
        wait(2)
        game:GetService("TweenService"):Create(Plox, TweenInfo.new(0.25), {TextColor3 = Color3.fromRGB(72, 72, 72)}):Play()
